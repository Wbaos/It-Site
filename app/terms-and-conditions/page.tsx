...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Terms of Service | CallTechCare",
    description:
      "Understand the CallTechCare Terms of Service covering service appointments, payments, warranties, and user responsibilities.",
    url: "https://www.calltechcare.com/terms-and-conditions",
